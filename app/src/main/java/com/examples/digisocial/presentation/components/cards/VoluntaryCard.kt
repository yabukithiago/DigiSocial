...
@Composable
fun VoluntaryCard(voluntary: Voluntary, onDeleteVoluntary: () -> Unit) {
    ...
    Card(
        ...
        Row(
            ...
            Column(
                ...
                InfoRow(icon = Icons.Default.Phone, text = voluntary.telefone)
                InfoRow(icon = Icons.Default.Email, text = voluntary.email)
                InfoRow(
                    icon = Icons.Default.Domain,
                    text = if (voluntary.privileged) "Voluntário Privilegiado" else "Voluntário"
                )
            }
