...
@Composable
fun PendingUserCard (navController: NavController, id: String, nome: String,
            ...
            Box(contentAlignment = Alignment.TopEnd) {
                ...
                DropdownMenu(
                    ...
                    DropdownMenuItem(
                        text = { Text("Editar") },
                        onClick = {
                            navController.navigate("editUser/$id")
                            menuExpanded = false
                        }
                    )
                    DropdownMenuItem(
                        text = { Text("Excluir") },
                        onClick = {
                            navController.navigate("deleteUser/$id")
                            menuExpanded = false
                        }
                    )
                }
...
@Composable
fun PreviewPendingUserCard(){
    PendingUserCard(navController = rememberNavController(), id = "123", nome = "Marcio Ponte",
