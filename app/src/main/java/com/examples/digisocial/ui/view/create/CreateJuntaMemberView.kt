...
@Composable
fun CreateJuntaMemberView(navController: NavController) {
    val viewmodel: CreateJuntaMemberViewModel = viewModel()
...
@Composable
fun CreateJuntaMemberViewPreview() {
    DigiSocialTheme {
        CreateJuntaMemberView(navController = rememberNavController())
    }
}